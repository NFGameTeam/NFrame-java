  ...
  const methods = {
    ...
    doEdit() {
      ...
      crud.crudMethod.edit(crud.form).then(() => {
        crud.status.edit = CRUD.STATUS.NORMAL
        var DataId=crud.getDataId(crud.form)
        var DataStatus=crud.getDataStatus(DataId)
    ...
    getQueryParams: function() {
      ...
      console.log('params',crud.params)
      console.log('query',crud.query)
      console.log('isPage',crud.isPage)
      if (!crud.isPage)
      {
        return {
          ...crud.query,
