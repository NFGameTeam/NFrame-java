...
import com.noahframe.nfcore.api.plugin.util.AndFileFilter;
import com.noahframe.nfcore.api.plugin.util.DirectoryFileFilter;
import com.noahframe.nfcore.api.plugin.util.FileUtils;
import com.noahframe.nfcore.api.plugin.util.HiddenFilter;
import com.noahframe.nfcore.api.plugin.util.NameFileFilter;
import com.noahframe.nfcore.api.plugin.util.NotFileFilter;
import com.noahframe.nfcore.api.plugin.util.OrFileFilter;
import com.noahframe.nfcore.api.plugin.util.Unzip;
import com.noahframe.nfcore.api.plugin.util.ZipFileFilter;
...
public class DefaultPluginManager implements PluginManager {
    ...
    /**
     * The plugins directory is supplied by System.getProperty("nf4j.pluginsDir", "plugins").
     */
        ...
        for (PluginWrapper pluginWrapper : resolvedPlugins) {
            ...
            if ((PluginState.DISABLED != pluginState) && (PluginState.STARTED != pluginState)) {
                try {
                    ...
                    pluginWrapper.getPlugin().Install();
        ...
        while (itr.hasNext()) {
            ...
            if (PluginState.STARTED == pluginState) {
                try {
                    ...
                    pluginWrapper.getPlugin().Uninstall();
	...
	public RuntimeMode getRuntimeMode() {
    	if (runtimeMode == null) {
        	...
        	String modeAsString = System.getProperty("nf4j.mode", RuntimeMode.DEPLOYMENT.toString());
    ...
    public Version getVersion() {
        ...
        Package nf4jPackage = getClass().getPackage();
        if (nf4jPackage != null) {
            version = nf4jPackage.getImplementationVersion();
            if (version == null) {
                version = nf4jPackage.getSpecificationVersion();
            }
        }
     ...
     * If a "nf4j.pluginsDir" system property is defined than this method returns
     * that directory.
    ...
    private void initialize() {
        ...
        log.info("NF4J version {} in '{}' mode", getVersion(), getRuntimeMode());
        ...
        //System.setProperty("plugins.Dir", pluginsDirectory.getAbsolutePath());
	}
