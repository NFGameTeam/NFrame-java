...
public class DefaultPluginFactory implements PluginFactory {
     ...
     */
    @Override
    public NFIPlugin create(final PluginWrapper pluginWrapper) {
        ...
        if (Modifier.isAbstract(modifiers) || Modifier.isInterface(modifiers)
                || (!NFIPlugin.class.isAssignableFrom(pluginClass))) {
        ...
        try {
            ...
            return (NFIPlugin) constructor.newInstance(pluginWrapper);
        } catch (Exception e) {
            log.error(e.getMessage(), e);
        }
