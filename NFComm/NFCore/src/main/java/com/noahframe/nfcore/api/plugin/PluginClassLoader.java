        ...
        synchronized (getClassLoadingLock(className)) {
            ...
            if (className.startsWith(PLUGIN_PACKAGE_PREFIX)) {
                ...
                try {
                    ...
                    // try next step
                    // TODO if I uncomment below lines (the correct approach) I received ClassNotFoundException for kernel (com.noahframe.plugins.kernel)
                    //                noahframe.error(e.getMessage(), e);
                    //                throw e;
                }
            }
