 ...
 */
package com.noahframe.nfcore.api.plugin.processor;


import com.noahframe.nfcore.api.plugin.Extension;
import com.noahframe.nfcore.iface.module.NFIExtensionPoint;
...
public class ExtensionAnnotationProcessor extends AbstractProcessor {
    ...
    private static final String STORAGE_CLASS_NAME = "nf4j.storageClassName";
...
//            Extension annotation = element.getAnnotation(Extension.class);
    ...
    private TypeMirror getExtensionPointType() {
        return processingEnv.getElementUtils().getTypeElement(NFIExtensionPoint.class.getName()).asType();
    }
